...
contract MyEpicNFT is ERC721{
    ...
    function makeAnEpicNFT() public {
        ...
        console.log("1: An NTF with id %s has been minted to %s", _tokenIds.current(), msg.sender);
        _tokenIds.increment();
    }
    ...
    function tokenURI(uint _tokenId)public view override returns (string memory){
        ...
        console.log("2: An NTF with id %s has been minted to %s", _tokenId, msg.sender);
        return string(
            abi.encodePacked(
